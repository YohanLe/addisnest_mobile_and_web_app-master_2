...
const PropertyListForm = () => {
    ...
    const ImagesUpload = async (file, index) => {
        try {
            ...
            const uploadUrl = `http://localhost:7001/api/media/upload`; // Use full URL to backend server
            console.log('Upload URL:', uploadUrl);
            
            const headers = {};
            // No authentication headers needed since we removed auth requirement
            
            console.log('Upload headers:', headers);
            console.log('FormData contents:', formData.get('mediaFiles'));
